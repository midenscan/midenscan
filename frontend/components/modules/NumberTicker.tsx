// Copied from https://github.com/browniefed/react-flip-ticker. Doesn't seem maintained so not using as a dependency.
...
export const NumberTickerInner: React.FC<Props> = ({
  children,
  textClassName,
...
export const NumberTicker = dynamic<any>(
  () =>
    import("components/modules/NumberTicker").then(
      (mod) => mod.NumberTickerInner
    ),
  {
