...
export function AccountUpdatesTableHeaders({
  orderBy,
  setOrderBy,
}: {
  orderBy: OrderBy;
    ...
    <thead className="bg-gray-50 dark:bg-darkMuted">
      <tr>
        ...
        >
          <div className="flex items-center gap-x-1">
            <div>State Hash</div>
            <InfoTooltip message={tooltipMessages.ACCOUNT_STATE_HASH} />
          </div>
        </th>
        <th
          scope="col"
          className="whitespace-nowrap px-2 pt-4 py-3.5 text-left text-sm font-semibold text-gray-900 dark:text-white"
        >
          <div className="flex items-center gap-x-1">
            <div>Nonce</div>
            <InfoTooltip message={tooltipMessages.ACCOUNT_NONCE} />
          </div>
        </th>
        <th
          scope="col"
        ...
        >
          <div className="flex items-center gap-x-1">
            ...
            <InfoTooltip
              message={tooltipMessages.ACCOUNT_COMMITTED_BLOCK_NUMBER}
            />
